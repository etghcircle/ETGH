...
A living archive of true friendship — where it all began, the moments that shaped it, and the memories three friends never want to lose.
...
- `ARCHITECTURE.md` — folder layout and data flow
